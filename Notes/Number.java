...
public class Number
{
    public static void prinRandomNumber(){
    ...
    public static void zeroToNine(){
        ...
        int randint = (int) randomNum; //Turns it into an int, deleting decimal
    ...
    public static void zeroToHundred(){
        int num = (int)(Math.random()*101); //101 refers to the number of possibilities
        System.out.println(num);
    }
